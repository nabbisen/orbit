...
#[cfg(target_os = "windows")]
const MONOSPACE_FONT: &str = "BIZ UDGothic";

#[cfg(target_os = "macos")]
const MONOSPACE_FONT: &str = "Hiragino Sans Mono";

#[cfg(target_os = "linux")]
const MONOSPACE_FONT: &str = "monospace";

/// get app font on non-linux
#[cfg(not(target_os = "linux"))]
pub fn monospace_font<'a>() -> &'a str {
    MONOSPACE_FONT
}
...
#[cfg(target_os = "linux")]
pub fn monospace_font<'a>() -> &'a str {
    linux_monospace_font()
}

/// get primary font on linux
#[cfg(target_os = "linux")]
fn linux_monospace_font() -> &'static str {
    let fonts = [
