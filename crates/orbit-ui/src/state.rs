...
//! `orbit-app` populates these structs from backend services; views
...
pub struct AppState {
    ...
    /// Total orbit storage in bytes (Storage view headline).
...
/// surfaced as messages here and executed by `orbit-app`'s update glue,
